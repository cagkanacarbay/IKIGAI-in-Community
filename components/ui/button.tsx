...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        default:
          "bg-purple-100 text-slate-50 shadow hover:bg-purple-400/90 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50/90",
        destructive:
        ...
        secondary:
          "bg-slate-100 text-slate-900 shadow-sm hover:bg-slate-50/80 dark:bg-slate-800 dark:text-slate-50 dark:hover:bg-slate-800/80",
