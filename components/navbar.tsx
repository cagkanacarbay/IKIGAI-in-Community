              ...
              {isDropdownOpen && (
                ...
                >
                  ...
                  <ul className="py-2" aria-labelledby="user-menu-button">
                    <li>
                      <a href={"/ikigai/me"} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                        My Ikigais
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href={'/api/auth/signout'} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                        Sign out
                      </a>
                    </li>
                  </ul>
