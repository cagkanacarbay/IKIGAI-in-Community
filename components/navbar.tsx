  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link href="#" className="flex items-center space-x-3 rtl:space-x-reverse" onClick={() => router.push('/create')}>
              ...
              {isDropdownOpen && (
                ...
                >
                  ...
                  <ul className="py-2" aria-labelledby="user-menu-button">
                    {/* <li>
                      <Link href={"/board/latest"} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                        Go to latest board
                      </Link>
                    </li> */}
                    {/* <li>
